...
for _ in range(20):#running actions randomly
	...
	while stop2 < 10:
		...
		while count_unexp < train_amount and count_extra < train_amount:  
		    ...
		    if len(learner_actions) == 0:#calling the learner2 functon to wrte to files
                	learner_actions = ad_hoc.learner2(obs, alive_ag, previous_action, step, 'pre_without.sp', 'AnswerSetObs', act_list, 'without.sp') #preASPLearner_file, answer_file, action, asp, asp_learn
                	learner_actions_exp = ad_hoc.learner2(obs, alive_ag, previous_action, step, 'pre_with.sp', 'AnswerSetExp', act_list, 'with.sp')
