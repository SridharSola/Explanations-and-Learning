...
next_to(8,14,9,14).
next_to(9,14,9,15).
facing(north,6,14,6,15).
facing(north,7,14,7,15).
facing(north,8,14,8,15).
facing(north,9,14,9,15).
facing(south,6,15,6,14).
facing(south,7,15,7,14).
facing(south,8,15,8,14).
facing(south,9,15,9,14).
...
facing(east,6,15,7,15).
facing(east,6,15,8,15).
facing(east,6,15,9,15).
facing(east,7,15,8,15).
facing(east,7,15,9,15).
facing(east,8,15,9,15).
facing(west,9,15,8,15).
facing(west,9,15,7,15).
facing(west,9,15,6,15).
facing(west,8,15,7,15).
facing(west,8,15,6,15).
facing(west,7,15,6,15).
...
facing(north_east,6,14,7,15).
facing(north_east,7,14,8,15).
facing(north_east,8,14,9,15).
facing(north_west,9,14,8,15).
facing(north_west,8,14,7,15).
facing(north_west,7,14,6,15).
facing(south_east,8,15,9,14).
facing(south_east,7,15,8,14).
facing(south_east,6,15,7,14).
facing(south_west,9,15,8,14).
facing(south_west,8,15,7,14).
facing(south_west,7,15,6,14).
goal(I) :- holds(agent_shot(attacker1),I).
holds(in(learner,6,14),0).
holds(face(learner,south),0).
-holds(shot(learner),0).
holds(agent_in(guard2,10,11),0).
holds(agent_face(guard2,south),0).
-holds(shot(guard2),0).
holds(agent_in(guard3,13,13),0).
holds(agent_face(guard3,south),0).
-holds(shot(guard3),0).
holds(agent_in(attacker1,8,15),0).
holds(agent_face(attacker1,north),0).
-holds(shot(attacker1),0).
holds(agent_in(attacker2,15,6),0).
holds(agent_face(attacker2,north),0).
holds(shot(attacker2),0).
holds(agent_in(attacker3,8,5),0).
holds(agent_face(attacker3,north),0).
holds(shot(attacker3),0).
holds(in(learner,6,14),1).
holds(face(learner,south),1).
-holds(shot(learner),1).
holds(agent_in(guard2,10,11),1).
holds(agent_face(guard2,south),1).
-holds(shot(guard2),1).
holds(agent_in(guard3,13,13),1).
holds(agent_face(guard3,south),1).
-holds(shot(guard3),1).
holds(agent_in(attacker1,9,15),1).
holds(agent_face(attacker1,north),1).
-holds(shot(attacker1),1).
holds(agent_in(attacker2,15,6),1).
holds(agent_face(attacker2,north),1).
holds(shot(attacker2),1).
holds(agent_in(attacker3,8,5),1).
